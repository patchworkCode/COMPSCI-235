...
from A3.adapters import memory_repository, database_repository
from A3.adapters.orm import metadata, map_model_to_tables
from A3.adapters.memory_repository import MemoryRepository


#TODO: You have to adapt these paths to your file structure
TEST_DATA_PATH_MEMORY = os.path.join('C:', os.sep, 'Users', 'idenf', 'OneDrive', 'Documents', 'GitHub', 'COMPSCI-235', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join('C:', os.sep, 'Users', 'idenf', 'OneDrive', 'Documents', 'GitHub', 'COMPSCI-235', 'tests', 'data', 'database')
